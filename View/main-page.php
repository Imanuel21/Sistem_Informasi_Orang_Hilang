    ...
    <nav class="navbar">
      ...
      <div class="nav-wrapper">
        ...
        <div class="nav-items">
          ...
          <?php
          //mendapatkan gambar untuk profile
        ...
        <div class="left-col">
          <div class="post">
            <div class="info">
              ...
              <form action="../Control/action-tambah-comment.php" method="GET">
                <input type="text" name="comment" class="comment-box" placeholder="Add a comment..." />
                <input hidden type="text" name="id_laporan"  value="<?php echo $no_laporan;?>" />
